...
const TechStack = () => {
  ...
  return (
    <section id="techstack" className="py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-transparent" aria-labelledby="techstack-heading">
      <div className="max-w-7xl mx-auto">
        <div className="bg-transparent rounded-2xl shadow-xl px-4 sm:px-8 py-12">
