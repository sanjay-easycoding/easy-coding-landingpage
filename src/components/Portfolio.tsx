...
const Portfolio = () => {
  ...
  const projects = [
    {
      ...
      link: 'https://web.nice-guides.com/'
    },
    {
  ...
  return (
    <section id="portfolio" className="py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-transparent" aria-labelledby="portfolio-heading">
      <div className="max-w-7xl mx-auto">
        <div className="bg-transparent  px-4 sm:px-8 py-12 ">
          ...
          {/* Carousel Container */}
          <div className="relative overflow-hidden rounded-2xl bg-[#eaeaea] shadow-md border border-slate-200">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center py-2 sm:py-4 lg:py-6 px-4 sm:px-6 lg:px-8">
                      ...
                      <div className="flex flex-col justify-center h-full">
                        ...
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <a href={project.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-cyan-600 hover:text-cyan-700 transition-all duration-300 group/link">
